...
async function main() {
  ...
  try {
    const bot: any = BotClient.getInstance()
    ...
    client.on('message', async (msg: any) => {
      ...
      if (messageTime < initializedAt) { return } // Impede o bot de interagir com pessoas que mandaram mensagem antes de sua inicialização
